...
class Category extends \Admin\Controllers\BaseController
{
    ...
    protected function getList()
    {
        ...
        $this->document->output('extension/blog/category_list', $data);
    }
    ...
    protected function getForm()
    {
        ...
        $this->document->output('extension/blog/category_form', $data);
    }
    ...
    protected function validateForm()
    {
        ...
        if (! $this->user->hasPermission('modify', 'extension/blog/category')) {
            $this->session->setFlashdata('error_warning', lang('extension/blog/category.error_permission'));
            return false;
        }
