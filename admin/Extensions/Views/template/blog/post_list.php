                ...
                <tbody>
                    <?php if ($posts) { ?>
                        <?php foreach ($posts as $post) { ?>
                            <tr>
                                <th scope="row"> <?php if (in_array($post['post_id'], $selected)) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <td class="text-center">  
                                        <a href="<?php echo $post['edit']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $button_edit; ?>" ><i class="far fa-edit"></i></a></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
