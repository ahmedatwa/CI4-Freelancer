    ...
    <div class="card-body">
      <form enctype="multipart/form-data" method="post" action="<?php echo $action; ?>" id="form-location" accept-charset="utf-8"> 
       ...
       <div class="form-group row required">
        <label for="input-title" class="col-md-2 col-form-label"><?php echo $entry_name; ?></label>
        <div class="col-md-10">
          <input class="form-control" type="text" id="input-title" value="<?php echo $name; ?>">
        </div>
      </div>
      <div class="form-group row required">
        <label for="input-body" class="col-md-2 col-form-label"><?php echo $entry_email; ?></label>
        <div class="col-md-10">
          <input class="form-control" type="text" id="input-email" value="<?php echo $email; ?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="input-body" class="col-md-2 col-form-label"><?php echo $entry_comment; ?></label>
        <div class="col-md-10">
          <textarea class="form-control" cols="7" rows="10" type="text" id="input-comment" value="<?php echo $comment; ?>"><?php echo $comment; ?></textarea>
        </div>
      </div>
        <div class="form-group row">
