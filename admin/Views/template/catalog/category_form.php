								...
								<div class="col-md-10">
									<?php foreach ($languages as $language) { ?>
										<div class="input-group mb-1">
											...
											<input class="form-control" type="text" id="input-seo-url-<?php echo $language['language_id']; ?>" name="seo_url[<?php echo $language['language_id']; ?>][keyword]" value="<?php echo $seo_url[$language['language_id']]['keyword'] ?? ''; ?>">
										</div>
									<?php } ?>		
								</div>
							</div>
