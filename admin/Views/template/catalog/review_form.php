			...
			<div class="card-body">
				<form enctype="multipart/form-data" method="post" action="<?php echo $action; ?>" id="form-location" accept-charset="utf-8"> 
								...
								<div class="form-group row required">
									...
									<div class="col-md-10">
										<input class="form-control" type="text" id="input-author" name="author" value="<?php echo $author; ?>">
									</div>
								</div>
								<div class="form-group row required">
									<label for="input-project-id" class="col-md-2 col-form-label"><?php echo $entry_project; ?></label>
									<div class="col-md-10">
										<select class="form-control" name="project_id" data-width="100%">
					                    <option></option>
								...
								<div class="form-group row">
									...
									<div class="col-md-10">
										<textarea class="form-control" type="text" id="input-text" name="text" cols="60" rows="8"><?php echo $text; ?></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label for="input-rating" class="col-md-2 col-form-label"><?php echo $entry_rating; ?></label>
									<div class="col-md-10">
										<input class="form-control" type="text" id="input-meta-description" name="rating" value="<?php echo $rating; ?>">
									</div>
								</div>
								<div class="form-group row">
									<label for="input-date-added" class="col-md-2 col-form-label"><?php echo $entry_date_added; ?></label>
									<div class="col-md-10">
										<input class="form-control" type="text" id="input-date-added" name="date_added" value="<?php echo $date_added; ?>">
									</div>
								</div>
								<div class="form-group row">
