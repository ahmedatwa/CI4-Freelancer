                        ...
                        <tbody>
                            <?php if ($skills) { ?>
                                <?php foreach ($skills as $skill) { ?>
                                    <tr>
                                        <th><?php if (in_array($skill['skill_id'], $selected)) { ?>
                                            <input type="checkbox" name="selected[]" value="<?php echo $skill['skill_id']; ?>" checked="checked" />
                                        <?php } else { ?>
                                            <input type="checkbox" name="selected[]" value="<?php echo $skill['skill_id']; ?>" />
                                        <?php } ?>
                                    </div>
                                </th>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo $skill['edit']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $button_edit; ?>"><i class="far fa-edit"></i></a></td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
                    </tbody>
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    url: '<?php echo $delete; ?>',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="<?php echo csrf_token(); ?>"]').attr('content'),
