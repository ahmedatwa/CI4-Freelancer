                ...
                <tbody>
                    <?php if ($customer_groups) { ?>
                        <?php foreach ($customer_groups as $group) { ?>
                            <tr>
                                <th scope="row"> <?php if (in_array($group['customer_group_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $group['customer_group_id']; ?>" checked="checked"/>
                                <?php } else { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $group['customer_group_id']; ?>"/>
                                    <?php } ?> </div></th>
                                    <td><?php echo $group['name']; ?></td>
                                    <td><?php echo $group['sort_order']; ?></td>
                                    <td class="text-center">  
                                        <a href="<?php echo $group['edit']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $button_edit; ?>" ><i class="far fa-edit"></i></a></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
