...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="form-group row required">
            <label for="input-locale" class="col-md-2 col-form-label">
                <span data-toggle="tooltip" title="<?php echo $help_code; ?>"><?php echo $entry_code; ?> <i class="fas fa-question-circle"></i>
                </span></label>
                <div class="col-md-10">
        ...
        <div class="form-group row required">
            <label for="input-locale" class="col-md-2 col-form-label">
                <span data-toggle="tooltip" title="<?php echo $help_locale; ?>"><?php echo $entry_locale; ?> <i class="fas fa-question-circle"></i></span></label>
                <div class="col-md-10">
                    <input class="form-control" type="text" id="input-locale" name="locale" value="<?php echo $locale; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="input-sort_order" class="col-md-2 col-form-label"><?php echo $entry_sort_order; ?></label>
                <div class="col-md-10">
                    <input class="form-control" type="sort_order" id="input-sort-order" name="sort_order" value="<?php echo $sort_order; ?>">
                </div>
            </div>
            <div class="form-group row">
