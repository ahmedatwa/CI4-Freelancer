            ...
            <div class="card-body">
               <form class="form-horizontal" enctype="multipart/form-data" id="form-location"> 
                   ...
                   <table id="table-location" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php if ($dispute_reasons) { ?>
                            <?php foreach ($dispute_reasons as $dispute) { ?>
                                <tr>
                                    <th scope="row"> <?php if (in_array($dispute['dispute_reason_id'], $selected)) { ?>
                                        <input type="checkbox" name="selected[]" value="<?php echo $dispute['dispute_reason_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                        <input type="checkbox" name="selected[]" value="<?php echo $dispute['dispute_reason_id']; ?>"/>
                                        <?php } ?> </div></th>
