                    ...
                    <tbody>
                        <?php if ($languages) { ?>
                            <?php foreach ($languages as $language) { ?>
                                <tr>
                                    <th scope="row"> <?php if (in_array($language['language_id'], $selected)) { ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <td class="text-center">  
                                            <a href="<?php echo $language['edit']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $button_edit; ?>" ><i class="far fa-edit"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
                            </tbody>
