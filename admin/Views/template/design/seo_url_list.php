                ...
                <tbody>
                    <?php if ($seo_urls) { ?>
                        <?php foreach ($seo_urls as $seo_url) { ?>
                            <tr>
                                <th scope="row"> <?php if (in_array($seo_url['seo_url_id'], $selected)) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php } ?> </div></th>
                                    <td><?php echo $seo_url['query']; ?></td>
                                    <td><?php echo $seo_url['keyword']; ?></td>
                                    <td class="text-center">  
                                        <a href="<?php echo $seo_url['edit']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $button_edit; ?>" ><i class="far fa-edit"></i></a></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
