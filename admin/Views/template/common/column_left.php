                           ...
                           <ul class="collapse" id="<?php echo $menu['id']; ?>">
                            <?php foreach($menu['children'] as $child) { ?>
                                ...
                                <?php if (!empty($child['children'])) { ?>
                                    <a href="#<?php echo $child['id']; ?>" data-toggle="collapse" aria-expanded="false" class="parent dropdown-toggle"><?php echo $child['name']; ?></a>
                                    <ul class="collapse" id="<?php echo $child['id']; ?>">
                                        <?php foreach($child['children'] as $child_2) { ?>
                                            <!-- level 3 -->
                                            <?php if (!empty($child_2['children'])) { ?>  
                                               <a href="#<?php echo $child_2['id']; ?>" data-toggle="collapse" aria-expanded="false" class="parent dropdown-toggle"><?php echo $child_2['name']; ?></a>
