...
<div class="container-fluid">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-group row required">
        <label for="input-slug" class="col-md-2 col-form-label"><?php echo $entry_slug; ?></label>
        <div class="col-md-10">
          <input class="form-control" type="text" id="input-slug" name="slug" value="<?php echo $slug;?>">
        </div>
      </div>
      <div class="form-group row required">
...
<script type="text/javascript">
  $("#input-title").keyup(function(){
    ...
    var slug = $value.replace(/[\W_]+/g,"-").toLowerCase();
    $("#input-slug").val(slug);
  });
</script>
<!-- <script type="text/javascript">
