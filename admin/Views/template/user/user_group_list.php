    ...
    <div class="page-header">
      <div class="container-fluid">
        <div class="float-right">
            <a href="<?php echo $add; ?>" class="btn btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="<?php echo $button_add; ?>"><i class="fas fa-plus"></i></a>
            <button type="button" id="button-delete" data-toggle="tooltip" data-placement="top" class="btn btn-danger waves-effect waves-light" title="<?php echo $button_delete;?>" disabled><i class="fa fa-trash"></i></button>
        </div>
                ...
                <tbody>
                    <?php if ($user_groups) { ?>
                        <?php foreach ($user_groups as $user_group) { ?>
                            <tr>
                                <th scope="row"> <?php if (in_array($user_group['user_group_id'], $selected)) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <td><?php echo $user_group['date_added']; ?></td>
                                    <td class="text-center">  
                                        <a href="<?php echo $user_group['edit']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $button_edit; ?>" ><i class="far fa-edit"></i></a></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
