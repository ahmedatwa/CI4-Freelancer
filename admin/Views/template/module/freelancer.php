    ...
    <div class="card-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
          ...
          <div class="col-sm-10">
            <input class="form-control" name="module_freelancer_limit" value="<?php echo $module_freelancer_limit; ?>">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
          <div class="col-sm-10">
            <select name="module_freelancer_status" id="input-status" class="form-control">
              <?php if ($module_freelancer_status) { ?>
