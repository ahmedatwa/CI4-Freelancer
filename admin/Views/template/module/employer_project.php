    ...
    <div class="card-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input name="module_employer_project_limit" value="<?php echo $module_employer_project_limit; ?>" class="form-control">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
          <div class="col-sm-10">
            <select name="module_employer_project_status" id="input-status" class="form-control">
              <?php if ($module_employer_project_status) { ?>
