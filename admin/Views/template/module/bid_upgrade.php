                    ...
                    <table class="table table-bordered" id="table-project-upgrade">
                      ...
                      <tbody>
                        ...
                        <tr id="social-row<?php echo $setting_row; ?>">
                          <td><input name="module_bid_upgrade_setting[<?php echo $setting_row; ?>][name]" value="<?php echo $setting['name']; ?>" class="form-control" id="input-name" /></td>
                          <td><input name="module_bid_upgrade_setting[<?php echo $setting_row; ?>][fee]" value="<?php echo $setting['fee']; ?>" class="form-control" id="input-fee" /></td>
                          ...
                          <td><button type="button" onclick="$('#setting-row<?php echo $setting_row; ?>, .tooltip').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                        </tr>
                        <?php $setting_row++; ?>
                        <?php } ?>
                      </tbody>
...
<script type="text/javascript">
  ...
  $('#button-module-add').on('click', function(){
    ...
    html += '<td><input type="text" class="form-control" name="module_bid_upgrade_setting['+ setting_row +'][name]"/></td>';
    html += '<td><input type="text" class="form-control" name="module_bid_upgrade_setting['+ setting_row +'][fee]"/></td>';
