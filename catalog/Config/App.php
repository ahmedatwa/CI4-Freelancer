...
class App extends BaseConfig
{
	 ...
	 * @var string
	 */
	public $baseURL = 'http://freelancer.localhost/';
	public $adminURL = 'http://freelancer.localhost/admin/';
	 ...
	 * @var string
	 */
	public $sessionCookieName = 'ci_catalog_session';
	 ...
	 * @var string
	 */
	public $CSRFTokenName = 'csrf_catalog_name';
