			...
			<?php foreach($categories as $category) { ?>
				<?php if ($category['children']) { ?>	
					<li class="nav-item dropdown megamenu-li" id="cats-navbar-dropdown">
						<a class="nav-link dropdown-toggle" href="<?php echo $category['href']; ?>" id="dropdown<?php echo $category['category_id']; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $category['name']; ?></a>
